...
void main()
{
    ...
    avg += weight[1] * imageLoad(source, pos + ivec2(0, 1));
    avg += weight[1] * imageLoad(source, pos + ivec2(0, -1));
    avg += weight[2] * imageLoad(source, pos + ivec2(0, 2));
    avg += weight[2] * imageLoad(source, pos + ivec2(0, -2));
    avg += weight[3] * imageLoad(source, pos + ivec2(0, 3));
    avg += weight[3] * imageLoad(source, pos + ivec2(0, -3));
    avg += weight[4] * imageLoad(source, pos + ivec2(0, 4));
    avg += weight[4] * imageLoad(source, pos + ivec2(0, -4));
